...
{
    public class HpAntalyaMerkezOptano : IEczaneNobetAntalyaMerkezOptimization
    {
        ...
        private VariableCollection<EczaneNobetIstatistik> _hPazartesiPS { get; set; }
        private VariableCollection<EczaneNobetIstatistik> _hPazartesiNS { get; set; }
        private VariableCollection<EczaneNobetIstatistik> _hSaliPS { get; set; }
        private VariableCollection<EczaneNobetIstatistik> _hSaliNS { get; set; }
        private VariableCollection<EczaneNobetIstatistik> _hCarsambaPS { get; set; }
        private VariableCollection<EczaneNobetIstatistik> _hCarsambaNS { get; set; }
        private VariableCollection<EczaneNobetIstatistik> _hPersembePS { get; set; }
        private VariableCollection<EczaneNobetIstatistik> _hPersembeNS { get; set; }
        private VariableCollection<EczaneNobetIstatistik> _hHiciPS { get; set; }
        private VariableCollection<EczaneNobetIstatistik> _hHiciNS { get; set; }
        ...
        private Model Model(AntalyaMerkezDataModel data)
        {
            ...
            _hPazartesiPS = new VariableCollection<EczaneNobetIstatistik>(
                                model,
            ...
            _hPazartesiNS = new VariableCollection<EczaneNobetIstatistik>(
                                model,
                                data.EczaneKumulatifHedefler,
                                "_hPazartesiNS",
                                null,
            ...
            _hSaliPS = new VariableCollection<EczaneNobetIstatistik>(
                                model,
                                data.EczaneKumulatifHedefler,
                                "_hSaliPS",
                                null,
            ...
            _hSaliNS = new VariableCollection<EczaneNobetIstatistik>(
                                model,
                                data.EczaneKumulatifHedefler,
                                "_hSaliNS",
                                null,
            ...
            _hCarsambaPS = new VariableCollection<EczaneNobetIstatistik>(
                    model,
                    data.EczaneKumulatifHedefler,
                    "_hCarsambaPS",
                    null,
            ...
            _hCarsambaNS = new VariableCollection<EczaneNobetIstatistik>(
                                model,
                                data.EczaneKumulatifHedefler,
                                "_hCarsambaNS",
                                null,
            ...
            _hPersembePS = new VariableCollection<EczaneNobetIstatistik>(
                    model,
                    data.EczaneKumulatifHedefler,
                    "_hPersembePS",
                    null,
            ...
            _hPersembeNS = new VariableCollection<EczaneNobetIstatistik>(
                                model,
                                data.EczaneKumulatifHedefler,
                                "_hPersembeNS",
                                null,
            ...
            _hHiciPS = new VariableCollection<EczaneNobetIstatistik>(
                                model,
                                data.EczaneKumulatifHedefler,
                                "_hHiciPS",
                                null,
            ...
            _hHiciNS = new VariableCollection<EczaneNobetIstatistik>(
                                model,
                                data.EczaneKumulatifHedefler,
                                "_hHiciNS",
                                null,
            ...
            foreach (var nobetGrup in data.NobetGruplar)
            {
                ...
                var fazlaYazilacakEczaneler = new List<EczaneNobetIstatistik>();
                ...
                foreach (var hedef in eczaneler)
                {
                        ...
                        foreach (var item in nobetGunKuralDetaylar.Where(w => w.GunKuralId > 0))
                        {
                            ...
                            var gunKuralNobetSayisi = data.EczaneNobetSonuclar
                                .Where(w => w.EczaneNobetGrupId == hedef.EczaneNobetGrupId
                                         && w.NobetGorevTipId == hedef.NobetGorevTipId
                                    ...
                                    model.AddConstraint(
                                            Expression.Sum(from i in data.EczaneNobetTarihAralik
                                                           ...
                                                           where i.EczaneNobetGrupId == j.EczaneNobetGrupId
                                                                 ...
                                                                 && i.GunDegerId == 2
                                                           select (_x[i] + _hPazartesiNS[j] - _hPazartesiPS[j])) == Std,
                                                            $"her eczaneye bir ayda nöbet grubunun {1} hedefi kadar nöbet yazılmalı, {Std}");
                                }
                                else if (gunKuralId == 3)
                                {//salı
                                    model.AddConstraint(
                                            Expression.Sum(from i in data.EczaneNobetTarihAralik
                                                           from j in data.EczaneKumulatifHedefler
                                                           where i.EczaneNobetGrupId == j.EczaneNobetGrupId
                                                                 ...
                                                                 && i.NobetGorevTipId == hedef.NobetGorevTipId
                                                                 && i.GunDegerId == 3
                                                           select (_x[i] + _hSaliNS[j] - _hSaliPS[j])) == Std,
                                                            $"her eczaneye bir ayda nöbet grubunun {1} hedefi kadar nöbet yazılmalı, {Std}");
                                }
                                else if (gunKuralId == 4)
                                {//çarşamba
                                    model.AddConstraint(
                                            Expression.Sum(from i in data.EczaneNobetTarihAralik
                                                           from j in data.EczaneKumulatifHedefler
                                                           where i.EczaneNobetGrupId == j.EczaneNobetGrupId
                                                                 ...
                                                                 && i.NobetGorevTipId == hedef.NobetGorevTipId
                                                                 && i.GunDegerId == 4
                                                           select (_x[i] + _hCarsambaNS[j] - _hCarsambaPS[j])) == Std,
                                                            $"her eczaneye bir ayda nöbet grubunun {1} hedefi kadar nöbet yazılmalı, {Std}");
                                }
                                else if (gunKuralId == 5)
                                {//perşembe
                                    model.AddConstraint(
                                            Expression.Sum(from i in data.EczaneNobetTarihAralik
                                                           from j in data.EczaneKumulatifHedefler
                                                           where i.EczaneNobetGrupId == j.EczaneNobetGrupId
                                                                 ...
                                                                 && i.NobetGorevTipId == hedef.NobetGorevTipId
                                                                 && i.GunDegerId == 5
                                                           select (_x[i] + _hPersembeNS[j] - _hPersembePS[j])) == Std,
                                                            $"her eczaneye bir ayda nöbet grubunun {1} hedefi kadar nöbet yazılmalı, {Std}");
                                }
                                else
                                {
                    ...
                    if (bayramlar.Count() > 0)
                    {
                        ...
                        {
                            var toplamBayramMax = hedef.ToplamBayram;
                    ...
                    if (haftaIciToplamMaxHedef)
                    {
                        ...
                        if (!haftaIciDurum.FazlaNobetTutacakEczaneler.Contains(hedef.EczaneNobetGrupId) && haftaIciDurum.FazlaNobetTutacakEczaneler.Count > 0)
                        {
                        ...
                        if (haftaIciToplamNobetSayisi <= Std)
                        {
                            model.AddConstraint(
                              Expression.Sum(data.EczaneNobetTarihAralik
                                            .Where(e => e.EczaneNobetGrupId == hedef.EczaneNobetGrupId
                            ...
                            //                      && i.NobetGorevTipId == hedef.NobetGorevTipId
                            //                      && tarihler.Contains(i.TakvimId)
                            //                select (_x[i] + _hHiciNS[j] - _hHiciPS[j])) == Std,
                        ...
                        else
                        {
                            model.AddConstraint(
                                 Expression.Sum(from i in data.EczaneNobetTarihAralik
                                                where i.EczaneNobetGrupId == hedef.EczaneNobetGrupId
                                                      && i.NobetGorevTipId == hedef.NobetGorevTipId
                                                      && tarihler.Contains(i.TakvimId)
                                                select (_x[i])) == 0,
                                                 $"her eczaneye bir ayda nöbet grubunun {1} hedefi kadar toplam hafta içi nobeti yazılmalı, {haftaIciToplam}");
        ...
        private NobetGunKuralDetay GetNobetGunKuralHaftaIciToplam(AntalyaMerkezDataModel data, int nobetGrupId, int gruptakiNobetciSayisi, int cozulenAydakiNobetSayisi)
        {
            ...
            var cozulenAydakiEksikNobetiOlanSayisi = cozulenAydakiNobetSayisi - eczaneNobetIstatistik.Count;
            ...
            if (enCokNobetTutulanNobetSayisi < kuralStd)
            {
                ...
                {
                    hicTutmayanlar = fazlaNobetTutacakEczaneler = tumEczaneler
                ...
                if (fazlaNobetTutacakEczaneSayisi > 0)
                {
                    fazlaNobetTutacakEczaneler = tumEczaneler
                        .Where(w => w.NobetSayisi == nobetFrekans.Select(s => s.NobetSayisi).Max()
                                 && !hicTutmayanlar.Contains(w.EczaneNobetGrupId))
                        .OrderBy(o => r.NextDouble())
