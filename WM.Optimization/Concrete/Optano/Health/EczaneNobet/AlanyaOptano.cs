...
{
    public class AlanyaOptano : IEczaneNobetAlanyaOptimization
    {
        ...
        private Model Model(AlanyaDataModel data)
        {
            ...
            var ayIciGrup = data.NobetUstGrupKisitlar
                            .Where(s => s.KisitAdi == "ayIciGrup"
                                        && s.NobetUstGrupId == data.NobetUstGrupId)
                            .Select(w => w.PasifMi == false).SingleOrDefault();
